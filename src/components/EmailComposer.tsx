    ...
    <div className="space-y-6 rounded-xl bg-white p-8 shadow-sm">
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            disabled={isRunning}
            className="w-full rounded-lg border-2 border-gray-200 px-4 py-2 transition focus:border-blue-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-50"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            disabled={isRunning}
            className="w-full rounded-lg border-2 border-gray-200 px-4 py-2 font-mono text-sm transition focus:border-blue-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-50"
          />
        </div>
        ...
        <div>
          ...
          <button
            ...
            disabled={isRunning}
            className="mt-2 rounded-lg bg-gray-100 px-4 py-2 font-semibold text-gray-800 transition hover:bg-gray-200 disabled:cursor-not-allowed disabled:opacity-50"
          >
            Load Recipients (
      ...
      {progress.total > 0 && (
        <div className="rounded-lg border-2 border-gray-200 bg-gray-50 p-6">
          ...
          <div className="relative mb-4 h-8 overflow-hidden rounded-full bg-gray-200">
            <div
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="rounded-lg border-2 border-green-500 bg-white p-4 text-center">
              <div className="mb-1 text-xs text-gray-600">Sent</div>
              <div className="text-2xl font-bold text-gray-900">
                {progress.sent}
              </div>
            </div>
            <div className="rounded-lg border-2 border-red-500 bg-white p-4 text-center">
              <div className="mb-1 text-xs text-gray-600">Failed</div>
              <div className="text-2xl font-bold text-gray-900">
                {progress.failed}
              </div>
            </div>
            <div className="rounded-lg border-2 border-yellow-500 bg-white p-4 text-center">
              <div className="mb-1 text-xs text-gray-600">Remaining</div>
              <div className="text-2xl font-bold text-gray-900">
      ...
      <div>
        {!isRunning ? (
          <button
            ...
            className="w-full rounded-lg bg-blue-600 px-6 py-4 text-lg font-bold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-gray-300"
          >
          ...
          <button
            ...
            className="w-full rounded-lg bg-red-600 px-6 py-4 text-lg font-bold text-white transition hover:bg-red-700"
          >
            Stop Campaign
          </button>
        )}
      ...
      {sentEmails.length > 0 && (
        <div>
          ...
          <div className="max-h-72 overflow-y-auto rounded-lg border-2 border-green-200 bg-green-50 p-4">
            {sentEmails
              .slice(-10)
              .reverse()
              .map((email, i) => (
                <div
                  key={i}
                  className="mb-2 flex items-center gap-3 rounded bg-white p-2"
                >
      ...
      {failedEmails.length > 0 && (
        <div>
          ...
          <div className="max-h-72 overflow-y-auto rounded-lg border-2 border-red-200 bg-red-50 p-4">
            {failedEmails.map((item, i) => (
              <div
                key={i}
                className="mb-2 flex items-start gap-3 rounded bg-white p-2"
              >
