            ...
            {activeTab === 'valid' && (
              <ul className="space-y-1">
                {validEmails.map((email, idx) => (
                  <li key={idx} className="text-sm text-gray-700 px-2 py-1 hover:bg-gray-50 rounded">
                    {email}
                  </li>
                ))}
              </ul>
            ...
            {activeTab === 'invalid' && (
              <ul className="space-y-1">
                {invalidEmails.map((item, idx) => (
                  <li key={idx} className="text-sm px-2 py-1 hover:bg-gray-50 rounded flex justify-between">
